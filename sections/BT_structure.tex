...
\label{sec:Crossing-BT}
    ...
    \begin{figure}[H]
        \begin{tikzpicture}[sibling distance=28mm, minimum width=1cm, minimum height=0.8cm]
            \node [draw] {$Root$}
                child {node [draw] {$\to$} edge from parent [-{Stealth[length=2.5mm]}]
                child {node [draw, xshift=0.5cm] {GetCars}}
                child {node [draw, xshift=0.5cm] {?}
                ...
                child {node [draw, xshift=0-1.1cm, yshift=0-1.5cm] {ContinueMovement}}}
                child {node [draw, xshift=2.5cm] {$\to$}
                child {node [diamond, draw, aspect=2.3, xshift=0.4cm] {StartCrossing}}
                child {node [draw, yshift=0-1.5cm] {CalculateCollision}}
                child {node [draw, xshift=0-0.4cm, yshift=0-1.5cm] {?}
                child {node [draw, xshift=0-2cm, yshift=0-0.7cm] {$\to$}
                ...
                child {node [draw, xshift=0-2.15cm, yshift=0-0.7cm] {ContinueMovement}}}}}
                child {node [diamond, draw, aspect=2.3, xshift=0.7cm] {Finished}}};
        \end{tikzpicture}
