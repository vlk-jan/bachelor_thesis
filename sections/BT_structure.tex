    ...
    \begin{figure}[ht]
        \begin{tikzpicture}[sibling distance=30mm, minimum width=1cm, minimum height=0.8cm]
            \node [draw] {$Root$}
                ...
                child {node [diamond, draw, aspect=2.9, yshift=0-0.5cm] {Perpendicular-BT}}}
                child {node [diamond, draw, aspect=2.3] {Crossing-BT}}}};
        \end{tikzpicture}
    ...
    \begin{figure}[ht]
        \begin{tikzpicture}[sibling distance=28mm, minimum width=1cm, minimum height=0.8cm]
            \node [draw] {$Root$}
                ...
                child {node [ellipse, draw, xshift=1.5cm] {CarsInTrajectory}}
                child {node [diamond, draw, aspect=2.3, xshift=0.9cm, yshift=0-1.5cm] {StartCrossing}}
                child {node [draw, xshift=0.3cm] {ContinueMovement}}}
                child {node [diamond, draw, aspect=2.3, xshift=0-1.3cm] {StartCrossing}}
                child {node [draw, xshift=0-1.3cm] {$\to$}
                child {node [draw, xshift=0.3cm, yshift=0-1.5cm] {CalculateCollision}}
                child {node [draw, xshift=0-0.1cm, yshift=0-1.5cm] {?}
                ...
                child {node [diamond, draw, aspect=2.3, xshift=0-1.9cm] {Finished}}};
        \end{tikzpicture}
    ...
    \begin{figure}[ht]
        ...
        \begin{subfigure}{0.49\textwidth}
            \begin{tikzpicture}[sibling distance=24mm, minimum width=1cm, minimum height=0.8cm]
                \node [draw] {$Root$}
                    child {node [draw] {?} edge from parent [-{Stealth[length=2.5mm]}]
                    child {node [draw] {CrossingFinished}}
                    child {node [draw] {$\neq$}
                    child {node [ellipse, draw] {StartAlgorithm}}}};
            \end{tikzpicture}
