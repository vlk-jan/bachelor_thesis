    ...
    \begin{figure}[H]
        \begin{tikzpicture}[sibling distance=28mm, minimum width=1cm, minimum height=0.8cm]
            \node [draw] {$Root$}
                ...
                child {node [draw] {$\to^{*}$}
                child {node [draw, xshift=0-2.5cm, yshift=0-0.1cm] {GetPosition}}
                child {node [ellipse, draw, xshift=0-2.6cm, yshift=0-0.1cm] {CrossRoad}}}
                child {node [draw] {?}
                child {node [ellipse, draw, xshift=1.9cm, yshift=0.3cm] {PlaceSuitable}}
                child {node [draw, xshift=1.65cm, yshift=0-0.3cm] {$\to$}
                child {node [ellipse, draw, xshift=0-1.1cm] {BetterPlace}}
                child {node [draw, xshift=0-0.6cm] {MoveToPlace}}}
                child {node [draw, yshift=0.65cm] {GetBetterPlace}}}};
        \end{tikzpicture}
