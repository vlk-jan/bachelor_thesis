\section{Behavior trees}
    ...
    \subsection{Common BT structures}
        ...
        \bfc{Condition-action}\\
            ...
            The \texttt{condition-action} structure starts with a \texttt{Fallback} node. Its first child is a condition node, and its second is an action node. The idea behind this structure is we want to check if an action has been performed, and if it has not, we want to perform it.\\
